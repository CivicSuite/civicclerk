...
- Python package metadata with the published `civiccore` v0.22.0 release wheel
...
- records-ready packet export bundles with CivicCore v0.22.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
6. Confirm the fresh-machine smoke-check path:
   - `GET http://127.0.0.1:8776/health` must return `{"status":"ok","service":"civicclerk","version":"0.1.20","civiccore":"0.22.0"}`
