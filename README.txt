...
Status: CivicClerk v0.1.19 runtime foundation release
Current version: `0.1.19`
Repository: <https://github.com/CivicSuite/civicclerk>  
Depends on: published `civiccore` v0.21.0 release wheel
...
- Python package metadata with the published `civiccore` v0.21.0 release wheel
...
- records-ready packet export bundles with CivicCore v0.21.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
- CivicClerk v0.1.19 release gate and build artifacts
...
6. Confirm the fresh-machine smoke-check path:
   - `GET http://127.0.0.1:8776/health` must return `{"status":"ok","service":"civicclerk","version":"0.1.19","civiccore":"0.21.0"}`
