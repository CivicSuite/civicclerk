...
- Python package metadata with `civiccore==0.5.0`
...
- records-ready packet export bundles with CivicCore v0.5.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
- CivicClerk v0.1.2 release gate and build artifacts
