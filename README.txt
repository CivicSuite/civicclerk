...
- React Vendor Sync workspace for registering approved vendor sources, showing
  ...
  making the no-network safety boundary plus IT fix guidance visible before
  scheduled vendor pulls are enabled
...
- actual vendor-network live connector adapters and scheduled pulls beyond the
