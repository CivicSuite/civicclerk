...
Status: CivicClerk v0.1.20 runtime foundation release
Current version: `0.1.20`
Repository: <https://github.com/CivicSuite/civicclerk>  
Depends on: published, Sigstore-attested `civiccore` 0.22.1 wheel from the `civiccore-m1-freeze` release asset
...
The current public `v0.1.20` release is a historical pre-gate artifact because
...
- Python package metadata with the published `civiccore` 0.22.1 wheel from the `civiccore-m1-freeze` release asset
...
- records-ready packet export bundles with CivicCore v0.22.1 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
- CivicClerk v0.1.20 release gate and build artifacts
...
6. Confirm the fresh-machine smoke-check path:
   - `GET http://127.0.0.1:8776/health` must return `{"status":"ok","service":"civicclerk","version":"0.1.20","civiccore":"0.22.1"}`
...
17. Follow GitHub issues and discussions as municipal IdP proof, real vendor API deployment proof, city-approved backup retention/off-host storage, and deployment hardening land.
