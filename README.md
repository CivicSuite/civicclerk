...
Status: CivicClerk v0.1.17 runtime foundation release
Current version: `0.1.17`
Repository: <https://github.com/CivicSuite/civicclerk>  
Depends on: published `civiccore` v0.19.0 release wheel
...
- Python package metadata with the published `civiccore` v0.19.0 release wheel
...
- records-ready packet export bundles with CivicCore v0.19.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
- CivicClerk v0.1.17 release gate and build artifacts
...
4. On Windows PowerShell, create a fresh virtual environment and install the current wheel:
   ...
   python -m pip install dist/civicclerk-0.1.17-py3-none-any.whl
   ```
...
6. Confirm the fresh-machine smoke-check path:
   - `GET http://127.0.0.1:8776/health` must return `{"status":"ok","service":"civicclerk","version":"0.1.17","civiccore":"0.19.0"}`
