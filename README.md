...
Status: CivicClerk v0.1.3 runtime foundation release  
Current version: `0.1.3`  
Repository: <https://github.com/CivicSuite/civicclerk>  
Depends on: published `civiccore` v0.9.0 release wheel
...
- Python package metadata with the published `civiccore` v0.9.0 release wheel
...
- records-ready packet export bundles with CivicCore v0.9.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
...
- CivicClerk v0.1.3 release gate and build artifacts
