...
- Python package metadata with `civiccore==0.6.0`
...
- records-ready packet export bundles with CivicCore v0.6.0 manifests, SHA256 checksums, provenance, and hash-chained audit events
