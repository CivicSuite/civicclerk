...
Status: CivicClerk v0.1.16 runtime foundation release
...
- CivicClerk v0.1.16 release gate and build artifacts
...
4. On Windows PowerShell, create a fresh virtual environment and install the current wheel:
   ...
   python -m pip install dist/civicclerk-0.1.16-py3-none-any.whl
   ```
...
6. Confirm the fresh-machine smoke-check path:
   - `GET http://127.0.0.1:8776/health` must return `{"status":"ok","service":"civicclerk","version":"0.1.16","civiccore":"0.18.1"}`
