...
Depends on: published, Sigstore-attested `civiccore` v0.22.1 release wheel
...
- Python package metadata with the published `civiccore` v0.22.1 release wheel
