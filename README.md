...
- React Agenda Intake workflow for submitting department agenda requests,
  reviewing them as ready or needing revision, and showing audit-hash evidence
  from the live `/api/agenda-intake` queue
