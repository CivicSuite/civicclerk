...
- vendor live-sync readiness primitives that validate proposed source URLs
  through CivicCore guards, reject credentials in URLs, compute
...
- actual vendor-network live connector adapters and scheduled pulls beyond the
  readiness/circuit-breaker foundation and scheduled local export-drop ingestion
