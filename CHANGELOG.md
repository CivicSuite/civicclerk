...
### Changed
- CivicClerk now pins `civiccore==0.7.0` so the release gate can consume the
  shipped shared verification and search helpers in addition to the existing
  audit, provenance, and export primitives.
