...
<!-- Project-specific items accumulate here. When the auditor surfaces a new drift pattern,
     add it as a checklist item AND add the longer entry in CivicClerk_AUDIT_PROTOCOL.md
     section 22.
