...
artifacts, CivicCore v0.8.0-backed packet export bundles, a database-backed
...
The runtime foundation now pins to civiccore `==0.6.0`. Agenda intake uses
...
The current production-depth branch pairs CivicClerk with the published `civiccore` v0.8.0 release wheel
...
records-ready packet export bundles using CivicCore v0.8.0 provenance, export
