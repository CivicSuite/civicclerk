...
artifacts, CivicCore v0.6.0-backed packet export bundles, a database-backed
...
The current production-depth branch pairs CivicClerk with `civiccore==0.6.0`
...
records-ready packet export bundles using CivicCore v0.6.0 provenance, export
