...
Status: CivicClerk v0.1.4 runtime foundation manual
Version: `0.1.4`
...
NovusAGENDA, accessibility/browser QA gates, CivicClerk v0.1.4 release
artifacts, CivicCore v0.11.0-backed packet export bundles, a database-backed
...
The runtime foundation now pins to the published `civiccore` v0.11.0 release wheel. Agenda intake uses
...
builds release artifacts and checksums, and publishes CivicClerk v0.1.4.
The current production-depth branch pairs CivicClerk with the published `civiccore` v0.11.0 release wheel
...
records-ready packet export bundles using CivicCore v0.11.0 provenance, export
