"""Milestone 12+ v1.0.2 release contract."""
...
def test_version_surfaces_are_synchronized_to_v101() -> None:
    ...
    assert "Current version: `1.0.2`" in current_docs
    assert "Version: `1.0.2`" in current_docs
    assert "v1.0.2" in current_docs
    assert "0.1.0.dev0" not in current_docs
    assert "## [1.0.2] - 2026-05-22" in changelog
...
def test_release_workflow_and_docs_reference_v101_release() -> None:
    ...
    assert "civicclerk v1.0.2" in docs
...
def test_fresh_install_rehearsal_script_prints_expected_plan() -> None:
    ...
    for expected in [
        ...
        "Expected health: {\"status\":\"ok\",\"service\":\"civicclerk\",\"version\":\"1.0.2\",\"civiccore\":\"1.2.0\"}",
...
def test_release_handoff_bundle_script_prints_expected_plan() -> None:
    ...
    for expected in [
        ...
        "Version: 1.0.2",
        "civicclerk-1.0.2-release-handoff.zip",
        "dist/civicclerk-1.0.2-py3-none-any.whl",
        "dist/civicclerk-1.0.2.tar.gz",
        "dist/SHA256SUMS.txt",
