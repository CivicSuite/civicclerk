...
def test_pyproject_targets_published_civiccore_v0210_release_wheel() -> None:
    data = load_pyproject()
    dependencies = data["project"]["dependencies"]

    assert (
        "civiccore @ https://github.com/CivicSuite/civiccore/releases/download/v0.21.0/"
        "civiccore-0.21.0-py3-none-any.whl"
    ) in dependencies
    assert not any(
