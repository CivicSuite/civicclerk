...
CIVICCORE_FREEZE_TAG="${CIVICCORE_FREEZE_TAG:-civiccore-m1-freeze}"
CIVICCORE_PACKAGE_VERSION="${CIVICCORE_PACKAGE_VERSION:-0.22.1}"
...
assert civicclerk.__version__ == "0.1.20"
...
manifest = {
    ...
    "pinning_rules": {
        "civiccore_dependency": "civiccore-m1-freeze release wheel",
    ...
    "network": {
        "allowed_during_provisioning_and_verification": [
            ...
            "https://github.com/CivicSuite/civiccore/releases/download/civiccore-m1-freeze/*",
